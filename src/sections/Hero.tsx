          ...
          <SectionContent className="relative isolate [mask-image:linear-gradient(to_bottom,transparent,black_10%,black_90%,transparent)]">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-semibold text-gray-100 text-center leading-tight">
              ...
              <span className="relative">
                <span>Sphereal</span>
                <span
                  className="absolute h-4 w-full left-0 top-full -translate-y-1/2 bg-[linear-gradient(to_right,var(--color-amber-300),var(--color-teal-300),var(--color-violet-400),var(--color-fuchsia-400))]"
                  style={{
            ...
            <div className="relative isolate max-w-5xl mx-auto">
              ...
              <div className="absolute top-[30%] left-0 -translate-x-10 z-10 hidden lg:block">
                <motion.div
                ...
                >
                  <div>Can you generate an incredible landing page?</div>
              ...
              <div className="absolute top-[50%] right-0 translate-x-10 z-10 hidden lg:block">
                <motion.div
                  className="bg-gray-800/70 backdrop-blur-md border-gray-700 rounded-xl p-4 w-72"
                  style={{
                    y: transformedY,
                ...
                >
                  <div>
                    <strong>Brainwave:</strong> I created based on your
                    requirements!
                  </div>
                  <div className="text-right text-gray-400 text-sm font-semibold">
                    Just now
              ...
              <div className="mt-20 rounded-2xl border-2 overflow-hidden border-gradient relative">
                ...
                <div className="absolute bottom-2 md:bottom-4 lg:bottom-10 left-1/2 -translate-x-1/2 w-full max-w-xs px-4">
                  <div className="bg-gray-950/80 flex items-center gap-4 px-4 py-2 rounded-2xl w-[320px]">
                    <Loader className="text-violet-400 fill-violet-400" />
